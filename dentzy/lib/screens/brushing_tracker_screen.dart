                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: const Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(Icons.sentiment_very_satisfied_rounded, color: Colors.white, size: 40),
                                SizedBox(height: 8),
                                Icon(Icons.brush_rounded, color: Colors.white, size: 24),
                              ],
                            ),
                          ),
                        ],
    ...
    return Column(
      ...
      children: [
        ...
        CustomCard(
          ...
          gradient: const LinearGradient(
            colors: [Color(0xFFFFF8E1), Color(0xFFFFF9E6)],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Icon(Icons.lightbulb_rounded, color: Color(0xFFFFA500), size: 24),
                  const SizedBox(width: 10),
                  Text(
                    loc.brushingTipsLabel,
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 6),
                      Text(
                        loc.percentage(int.tryParse(percentage) ?? 0),
                        style: const TextStyle(
                          color: Colors.white70,
                          fontSize: 14,
                        ),
        ...
        CustomCard(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildStatRow(loc.totalBrushings, '$total/60'),
              const Divider(height: 24),
              _buildStatRow(loc.completionRate, '$percentage%'),
              const Divider(height: 24),
              _buildStatRow(loc.daysTracked, '30 ${loc.daysTracked.toLowerCase()}'),
              const Divider(height: 24),
              _buildStatRow(loc.averagePerDay, (total / 30).toStringAsFixed(1)),
            ],
          ),
        ),
      ],
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: (isCompleted ? AppTheme.successColor : Colors.grey[350]!)
                    .withOpacity(0.3),
                blurRadius: 12,
...
class _TrackerBackdrop extends StatelessWidget {
  const _TrackerBackdrop();
